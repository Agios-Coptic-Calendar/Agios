    ...
    private var magnificationGesture: some Gesture {
        MagnifyGesture(minimumScaleDelta: 0)
            .onChanged { value in
                ...
                NotificationCenter.default.post(name: NSNotification.Name("MagnifyGestureScaleChanged"), object: value.magnification)
            }
            .onEnded { _ in
                onEndGesture()
            }
    ...
    private var doubleTapGesture: some Gesture {
        SpatialTapGesture(count: 2)
            .onEnded { value in
                ...
                let newScale = transform.isIdentity ? 1.0 : doubleTapZoomScale
                            NotificationCenter.default.post(name: NSNotification.Name("MagnifyGestureScaleChanged"), object: newScale)
            }
    }
